								...
								<h4 className="flex">
									<span>
										...
										<img
											...
											className="mr-2 p-1"
										/>
										Insights to strengthen your connection with {getCapitalized(defaultChildData?.firstName)}
									</span>
									<button
							...
							<div className="welcomscreenContent">
								<ul>
									<li>
										...
										<h4>
											{" "}
											We've gathered valuable tips and insights to strengthen your connection with {getCapitalized(defaultChildData?.firstName)}.
									...
									<li>
										...
										<h4>
											{" "}
											You can access them when you enroll {getCapitalized(defaultChildData?.firstName)} in this course.
										</h4>
									</li>
